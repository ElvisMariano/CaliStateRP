Config = {
    Items = {
        ["weed"] = {
            label = "Marijuana",
            type = "item_standard",
            illegal_level = 1, -- Might be helpful in the future with substance value.
            usable = true,
            reusable = false, -- Reusable means the item will not decrease it's amount on usage, however transactions with the item will not be affected.
            removeable = true, -- If set to false, they cannot drop/give this from their inventory.
            max = 20,
            cl_action = function() -- (DONT USE ON THE SV SIDE) Clientsided action for when the item is used, leave it empty to only perform the framework's default function. 
                TriggerEvent("cf_drugs:StartEffect", "weed")
            end,
            sv_action = function() -- (DONT USE ON THE CL SIDE) Serversided action for when the item is used, leave it empty to only perform the framework's default function. 
            end,
        },
        ["opium"] = {
            label = "Opium",
            ...
            max = 20,
            cl_action = function() -- (DONT USE ON THE SV SIDE) Clientsided action for when the item is used, leave it empty to only perform the framework's default function. 
                TriggerEvent("cf_drugs:StartEffect", "opium")
            end,
            sv_action = function() -- (DONT USE ON THE CL SIDE) Serversided action for when the item is used, leave it empty to only perform the framework's default function. 
            end,
        },
        ["meth"] = {
            ...
            max = 20,
            cl_action = function() -- (DONT USE ON THE SV SIDE) Clientsided action for when the item is used, leave it empty to only perform the framework's default function. 
                TriggerEvent("cf_drugs:StartEffect", "meth")
            end,
            sv_action = function() -- (DONT USE ON THE CL SIDE) Serversided action for when the item is used, leave it empty to only perform the framework's default function. 
            end,
        },
	    ["croquettes"] = {
            ...
            max = 20,
            cl_action = function() -- (DONT USE ON THE SV SIDE) Clientsided action for when the item is used, leave it empty to only perform the framework's default function. 
                TriggerEvent("cf_drugs:StartEffect", "croquettes")
            end,
            sv_action = function() -- (DONT USE ON THE CL SIDE) Serversided action for when the item is used, leave it empty to only perform the framework's default function. 
            end,
        },
        ...
        ["coke"] = {
            ...
            max = 20,
            cl_action = function() -- (DONT USE ON THE SV SIDE) Clientsided action for when the item is used, leave it empty to only perform the framework's default function. 
                TriggerEvent("cf_drugs:StartEffect", "coke")
            end,
            sv_action = function() -- (DONT USE ON THE CL SIDE) Serversided action for when the item is used, leave it empty to only perform the framework's default function. 
            end,
        },
        ["cash"] = {
            ...
            max = 20000,
            cl_action = function() -- (DONT USE ON THE SV SIDE) Clientsided action for when the item is used, leave it empty to only perform the framework's default function. 
                TriggerEvent("cf_drugs:StartEffect", "cash")
            end,
            sv_action = function() -- (DONT USE ON THE CL SIDE) Serversided action for when the item is used, leave it empty to only perform the framework's default function. 
            end,
        },
        ["acid"] = {
            ...
            max = 10,
            cl_action = function() -- (DONT USE ON THE SV SIDE) Clientsided action for when the item is used, leave it empty to only perform the framework's default function. 
                TriggerEvent("cf_drugs:StartEffect", "acid")
            end,
            sv_action = function() -- (DONT USE ON THE CL SIDE) Serversided action for when the item is used, leave it empty to only perform the framework's default function. 
            end,
        },
        ["Aderral"] = {
            ...
            max = 15,
            cl_action = function() -- (DONT USE ON THE SV SIDE) Clientsided action for when the item is used, leave it empty to only perform the framework's default function. 
                TriggerEvent("cf_drugs:StartEffect", "Aderral")
            end,
            sv_action = function() -- (DONT USE ON THE CL SIDE) Serversided action for when the item is used, leave it empty to only perform the framework's default function. 
            end,
        },
